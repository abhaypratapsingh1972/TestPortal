    ...
    this.state = {
      content: (
        <div className={this.props.classes.welcomeMessage}>
          <h1 className={this.props.classes.welcomeMessageTitle}>Welcome to Teacher Dashboard</h1>
          <p className={this.props.classes.welcomeMessageText}>
            Manage your questions, create tests, and monitor student performance from the sidebar menu.
          </p>
        </div>
      ),
      menuList: [{
